...
public class GeradorDeGraficosBiometria {
	...
	public JFreeChart graficoPeriodoDeCrescimento(List<Biometria> lista, String titulo, String labelBottom,
		...
		/*renderer.setSeriesStroke(0,
				new BasicStroke(1.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND, 10.f, dash, 0.0f));
	...
	public JFreeChart graficoTotalDeOstras(List<Biometria> lista, String titulo, String labelBottom,
			String labelLeft) {
		DefaultCategoryDataset dataset = new DefaultCategoryDataset();
